...
// Module: AppShell
// Depends on: react, next/navigation, ./Sidebar, ./Header, @/services/_registry/serviceMeta, @/lib/store/AppStore
// Description: Application shell used by protected pages.
...
/** Renders the dashboard shell with sidebar and header. */
